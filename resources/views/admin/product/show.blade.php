...
@section('breadcrumb')
  ...
  <li class="breadcrumb-item active"><a href="{{route('admin.product.show',$productos->slug)}}" style="text-decoration: underline; color:gray;">@yield('titulo')</a></li>
@endsection
       ...
       <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <a class="btn btn-success " href="{{route('admin.product.edit',$productos->slug)}}" >Editar</a>
